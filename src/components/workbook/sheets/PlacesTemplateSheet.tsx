...
interface PlacesTemplateSheetProps {
  sheet: Sheet;
}

const PlacesTemplateSheet = ({ sheet }: PlacesTemplateSheetProps) => {
    ...
    <div className="h-full overflow-auto p-4">
      <Tabs defaultValue="accommodations" className="space-y-4">
        ...
        <TabsContent value="accommodations">
          <AccommodationsTab tripId={tripId} />
        </TabsContent>
        
        <TabsContent value="transport">
          <TransportTab tripId={tripId} />
        </TabsContent>
      </Tabs>
    </div>
  );
...
export default PlacesTemplateSheet;
